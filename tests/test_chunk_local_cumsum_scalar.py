...
from tests.register_ops import chunk_local_cumsum_scalar
...
class TestTorchMethod:
    ...
    def ref_chunk_local_cumsum_scalar(
        self,
        g: torch.Tensor,
        chunk_size: int,
        reverse: bool = False,
    ...
    def test_deepseek_scaling_rope(
        ...
        ref_out = self.ref_chunk_local_cumsum_scalar(
            g, chunk_size, reverse, cu_seqlens, head_first, output_dtype)
        out = chunk_local_cumsum_scalar(g, chunk_size, reverse, cu_seqlens, head_first, output_dtype)
